...
//        ui->usertable->setItem(i-1,8, new QTableWidgetItem(QString::number(T[CG[n][i]].tv)));
        ui->usertable->setItem(i-1,0, new QTableWidgetItem(QString::number(obj.N)));
        ui->usertable->setItem(i-1,1, new QTableWidgetItem(QString::number(obj.No)));
        ui->usertable->setItem(i-1,2, new QTableWidgetItem(QString::number(obj.NG)));
        ui->usertable->setItem(i-1,3, new QTableWidgetItem(QString::number(obj.ti)));
        ui->usertable->setItem(i-1,4, new QTableWidgetItem(QString::number(obj.Status)));
        ui->usertable->setItem(i-1,5, new QTableWidgetItem(QString::number(obj.tn)));
        ui->usertable->setItem(i-1,6, new QTableWidgetItem(QString::number(obj.nm)));
        ui->usertable->setItem(i-1,7, new QTableWidgetItem(QString::number(obj.S)));
        ui->usertable->setItem(i-1,8, new QTableWidgetItem(QString::number(obj.tv)));
