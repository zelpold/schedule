...
//    };
    ...
    Qwork,                      // кол-во работ
    matrix1[100][100], matrix2[100][100],matrix3[100],
    CurTime,                    //
    ...
    int CA[10001],CW[10001];            // конфликты и весы конфликтов
    int CG[101][101];                  // группы конфликтов
    int CMG[101];                   // кол-во операций в ГК
    Twork W[10001] ,T[10001];       // массив работ
    QStringList Names;
    int NamesCount;
